...
class Case:
    ...
    Attributes:
        ...
        est_marquee_d_un_drapeau (bool): True si la case est marquée d'un drapeau, False autrement. Cet attribut sera
        utilisé dans interface_partie.py.
    """
    ...
    def __init__(self):
        ...
        self.est_marquee_d_un_drapeau = False
